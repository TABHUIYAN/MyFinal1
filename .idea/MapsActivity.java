...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        for(int i = 0; i < ListItem.xLat.size(); i++)

            mMap.addMarker(new MarkerOptions().position(new LatLng(ListItem.xLat.get(i), ListItem.yLng.get(i))).title(ListItem.myName.get(i)));
